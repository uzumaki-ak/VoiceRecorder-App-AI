...
class GroqClient(private val apiKey: String, private val model: String) : LLMProvider {
    ...
    override suspend fun sendMessage(
        ...
        try {
            ...
            if (response.isSuccessful && responseBody != null) {
                ...
                Result.failure(Exception("Groq API error: ${response.code} - $responseBody"))
            }
        } catch (e: Exception) {
            Result.failure(e)
        }
    ...
    override fun getAvailableModels(): List<String> = Constants.GROQ_MODELS
}